...
foreign import ccall unsafe "af_product"
    af_product :: Ptr AFArray -> AFArray -> Int -> IO AFErr
foreign import ccall unsafe "af_product_nan"
    af_product_nan :: Ptr AFArray -> AFArray -> Int -> Double -> IO AFErr
foreign import ccall unsafe "af_min"
    af_min :: Ptr AFArray -> AFArray -> Int -> IO AFErr
foreign import ccall unsafe "af_max"
    af_max :: Ptr AFArray -> AFArray -> Int -> IO AFErr
foreign import ccall unsafe "af_all_true"
    af_all_true :: Ptr AFArray -> AFArray -> Int -> IO AFErr
foreign import ccall unsafe "af_any_true"
    af_any_true :: Ptr AFArray -> AFArray -> Int -> IO AFErr
foreign import ccall unsafe "af_count"
    af_count :: Ptr AFArray -> AFArray -> Int -> IO AFErr
...
foreign import ccall unsafe "af_imin"
    af_imin :: Ptr AFArray -> Ptr AFArray -> AFArray -> Int -> IO AFErr
...
foreign import ccall unsafe "af_scan"
    af_scan :: Ptr AFArray -> AFArray -> Int -> AFBinaryOp -> Bool -> IO AFErr
foreign import ccall unsafe "af_scan_by_key"
    af_scan_by_key :: Ptr AFArray -> AFArray -> AFArray -> Int -> AFBinaryOp -> Bool -> IO AFErr
foreign import ccall unsafe "af_where"
    af_where :: Ptr AFArray -> AFArray -> IO AFErr
foreign import ccall unsafe "af_diff1"
    af_diff1 :: Ptr AFArray -> AFArray -> Int -> IO AFErr
...
foreign import ccall unsafe "af_set_union"
    af_set_union :: Ptr AFArray -> AFArray -> AFArray -> Bool -> IO AFErr
foreign import ccall unsafe "af_set_intersect"
    af_set_intersect :: Ptr AFArray -> AFArray -> AFArray -> Bool -> IO AFErr